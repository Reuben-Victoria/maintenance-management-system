...
export default function AdminReports() {
  ...
  const handleExport = () => {
    // We construct the URL and fetch it manually to handle the CSV download
      ...
      <Card className="border-border/50 shadow-sm">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <FileSpreadsheet className="h-5 w-5 text-primary" /> Requests Export
          </CardTitle>
          <CardDescription>Filter requests by status and date range before exporting to CSV.</CardDescription>
        </CardHeader>
